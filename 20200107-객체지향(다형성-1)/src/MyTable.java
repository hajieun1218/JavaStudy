...
public class MyTable extends JFrame implements ActionListener, MouseListener {
	...
	public MyTable() {
		...
		table.getTableHeader().setReorderingAllowed(false);  // 테이블헤더 고정
//		table.setShowHorizontalLines(false);   // 가로선 지우기
		table.setShowGrid(false);   // 가로세로 지우기
